    ...
    <div class="col-12">
        <div class="card card-primary">
          ...
          <div class="card-body table-responsive">
              ...
              <br>
              <form method="GET" action="{{route('tampil2')}}">
                  <div class="row">
                      <div class="col-2 ">
                          <b>Search Nama</b>
                      </div>
          ...
          <thead>
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td>{{ $loop->iteration + ($tampil2->perPage() * ($tampil2->currentPage() - 1) ) }}
                          </td>
                          <td><p><a class="link-offset-2 link-underline link-underline-opacity-0" href="{{ route('show2', [$row->id])}}">{{$row->jenis}}</a></p>
